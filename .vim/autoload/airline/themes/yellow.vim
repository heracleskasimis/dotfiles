...
let g:airline#themes#cyan#palette.normal.airline_warning_inactive = [
     \ s:WII[0], s:WII[1], s:WII[2], s:WII[3]
     \ ]

let g:airline#themes#cyan#palette.normal.airline_z_to_airline_warning_inactive = [
